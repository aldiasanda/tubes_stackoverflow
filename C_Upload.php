...
class C_Upload extends CI_Controller {
        ...
        public function do_upload()
        {
                ...
                $config['max_width']            =  1920;    //isi dengan lebar maksimum gambar yang bisa di upload
                $config['max_height']           =  1920;     //isi dengan panjang maksimum gambar yang bisa di upload
